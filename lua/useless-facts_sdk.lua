...
local UselessFactsSDK = {}
UselessFactsSDK.__index = UselessFactsSDK
...
UselessFactsSDK._make_feature = _make_feature


function UselessFactsSDK.new(options)
  local self = setmetatable({}, UselessFactsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function UselessFactsSDK:options_map()
...
function UselessFactsSDK:get_utility()
  return Utility.copy(self._utility)
end


function UselessFactsSDK:get_root_ctx()
  return self._rootctx
end


function UselessFactsSDK:prepare(fetchargs)
...
function UselessFactsSDK:direct(fetchargs)
...
-- by passing it.
function UselessFactsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function UselessFactsSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "UselessFactsSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function UselessFactsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = UselessFactsSDK.new(sdkopts)
  sdk.mode = "test"
