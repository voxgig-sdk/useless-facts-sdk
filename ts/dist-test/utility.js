...
function envOverride(m) {
    if ('TRUE' === process.env.USELESS_FACTS_TEST_LIVE ||
        'TRUE' === process.env.USELESS_FACTS_TEST_OVERRIDE) {
    ...
    m.USELESS_FACTS_TEST_EXPLAIN = process.env.USELESS_FACTS_TEST_EXPLAIN || m.USELESS_FACTS_TEST_EXPLAIN;
    return m;
}
