...
(0, node_test_1.describe)('TodayEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'today.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(today_ref01_data_dt0.id === today_ref01_data.id);
    });
});
