...
(0, node_test_1.describe)('TodayDirect', async () => {
    // Per-test live pacing. Delay is read from sdk-test-control.json's
    // `test.live.delayMs`; only sleeps when USELESS_FACTS_TEST_LIVE=TRUE.
    (0, node_test_1.afterEach)((0, utility_1.liveDelay)('USELESS_FACTS_TEST_LIVE'));
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.UselessFactsSDK({
    ...
    (0, node_test_1.test)('direct-load-today', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-today', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.UselessFactsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['USELESS_FACTS_TEST_TODAY_ENTID'];
    ...
    const client = new __1.UselessFactsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TodayDirect.test.js.map