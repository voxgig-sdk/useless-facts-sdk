...
(0, node_test_1.describe)('RandomEntity', async () => {
    ...
    (0, node_test_1.test)('instance', async () => {
        const testsdk = __1.UselessFactsSDK.test();
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        if (setup.syntheticOnly) {
            t.skip('live entity test uses synthetic IDs from fixture — set USELESS_FACTS_TEST_RANDOM_ENTID JSON to run live');
            return;
        }
...
function basicSetup(extra) {
    ...
    let client = __1.UselessFactsSDK.test(options, extra);
    ...
    const idmapEnvVal = process.env['USELESS_FACTS_TEST_RANDOM_ENTID'];
    ...
    if (live) {
        client = new __1.UselessFactsSDK(merge([
