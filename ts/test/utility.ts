...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.USELESSFACTS_TEST_LIVE ||
    'TRUE' === process.env.USELESSFACTS_TEST_OVERRIDE
  ) {
  ...
  m.USELESSFACTS_TEST_EXPLAIN = process.env.USELESSFACTS_TEST_EXPLAIN || m.USELESSFACTS_TEST_EXPLAIN
