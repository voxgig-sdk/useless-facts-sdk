...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/useless-facts` | `npm install @voxgig-sdk/useless-facts` |
| Python | `voxgig-sdk-useless-facts` | `pip install voxgig-sdk-useless-facts` |
| PHP | `voxgig-sdk/useless-facts` | `composer require voxgig-sdk/useless-facts` |
| Golang | `github.com/voxgig-sdk/useless-facts-sdk/go` | `go get github.com/voxgig-sdk/useless-facts-sdk/go` |
| Ruby | `voxgig-sdk-useless-facts` | `gem install voxgig-sdk-useless-facts` |
| Lua | `voxgig-sdk-useless-facts` | `luarocks install voxgig-sdk-useless-facts` |
