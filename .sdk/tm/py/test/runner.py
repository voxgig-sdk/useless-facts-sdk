...
class UselessFactsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UselessFactsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = UselessFactsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = UselessFactsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
