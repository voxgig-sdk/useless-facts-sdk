...
class UselessFactsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UselessFactsTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = UselessFactsTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = UselessFactsTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
