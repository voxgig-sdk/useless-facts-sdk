...
class UselessFactsRbacFeature extends UselessFactsBaseFeature
{
    ...
    private function _required(UselessFactsContext $ctx): ?string
    {
    ...
    private function _reject(UselessFactsContext $ctx, string $required): void
    {
    ...
    private function _track(UselessFactsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
