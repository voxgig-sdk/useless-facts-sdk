...
// UselessFacts SDK audit feature
...
class UselessFactsAuditFeature extends UselessFactsBaseFeature
{
    ...
    private function _emit(UselessFactsContext $ctx, string $outcome): void
    {
