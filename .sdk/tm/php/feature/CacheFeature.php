...
// UselessFacts SDK cache feature
...
class UselessFactsCacheFeature extends UselessFactsBaseFeature
{
    ...
    private function _through(UselessFactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
