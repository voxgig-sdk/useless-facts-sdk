...
// UselessFacts SDK timeout feature
...
class UselessFactsTimeoutFeature extends UselessFactsBaseFeature
{
    ...
    private function _with_timeout(UselessFactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(UselessFactsContext $_ctx, float $ms): void
    {
        $client = $this->client;
