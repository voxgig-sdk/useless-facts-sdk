...
// UselessFacts SDK utility: fetcher

class UselessFactsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; UselessFactsSDK/1.0)';
    ...
    public static function call(UselessFactsContext $ctx, string $fullurl, array $fetchdef): array
    {
