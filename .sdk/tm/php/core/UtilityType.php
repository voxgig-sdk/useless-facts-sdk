...
// UselessFacts SDK utility type

class UselessFactsUtility
{
    ...
    public static function copy(UselessFactsUtility $src): UselessFactsUtility
    {
        $u = new UselessFactsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
