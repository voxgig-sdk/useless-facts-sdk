...
// UselessFacts SDK pipeline test
//
...
{
    private static function utility(): UselessFactsUtility
    {
        return new UselessFactsUtility();
    }
    ...
    private static function ctx(array $over = []): UselessFactsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new UselessFactsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new UselessFactsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof UselessFactsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new UselessFactsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = UselessFactsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new UselessFactsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = UselessFactsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new UselessFactsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = UselessFactsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UselessFactsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = UselessFactsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new UselessFactsResponse([]),
            'result' => new UselessFactsResult([]),
        ]);
        [, $err] = UselessFactsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new UselessFactsSpec([]),
            'response' => null,
            'result' => new UselessFactsResult([]),
        ]);
        [, $err] = UselessFactsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new UselessFactsSpec(['step' => 's']),
            'response' => new UselessFactsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new UselessFactsResult([]),
        ]);
        [, $err] = UselessFactsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new UselessFactsSpec(['step' => 's']),
            'response' => new UselessFactsResponse(self::resp(200, ['v' => 1])),
            'result' => new UselessFactsResult([]),
        ]);
        [, $err] = UselessFactsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new UselessFactsSpec(['step' => 's']),
            'response' => new UselessFactsResponse(self::resp(200, ['v' => 2])),
            'result' => new UselessFactsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        UselessFactsMakeResponse::call($ctx);
    ...
    {
        $preset = new UselessFactsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new UselessFactsSpec([]),
            'response' => new UselessFactsResponse([]),
            'result' => new UselessFactsResult([]),
        ...
        [$got, $err] = UselessFactsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new UselessFactsResult([])]);
        [, $err] = UselessFactsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new UselessFactsSpec([]), 'result' => null]);
        [, $err] = UselessFactsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UselessFactsSpec(['step' => 's']),
            'result' => new UselessFactsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new UselessFactsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UselessFactsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new UselessFactsSpec(['step' => 's']),
            'result' => new UselessFactsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new UselessFactsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = UselessFactsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new UselessFactsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new UselessFactsSpec([]),
            'result' => new UselessFactsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = UselessFactsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UselessFactsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new UselessFactsError('boom', 'boom');
        $utility->fetcher = function (UselessFactsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UselessFactsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = UselessFactsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (UselessFactsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = UselessFactsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(UselessFactsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        UselessFactsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (UselessFactsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new UselessFactsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = UselessFactsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new UselessFactsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new UselessFactsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = UselessFactsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = UselessFactsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = UselessFactsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new UselessFactsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, UselessFactsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new UselessFactsResult(['ok' => false])]);
        $this->expectException(UselessFactsError::class);
        UselessFactsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new UselessFactsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', UselessFactsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        UselessFactsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new UselessFactsBaseFeature();
        $b = new UselessFactsBaseFeature();
        UselessFactsFeatureAdd::call($ctx, $a);
        UselessFactsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): UselessFactsBaseFeature
    {
        $f = new UselessFactsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        UselessFactsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): UselessFactsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new UselessFactsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = UselessFactsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        UselessFactsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new UselessFactsResponse(['headers' => null]),
            'result' => new UselessFactsResult([]),
        ]);
        UselessFactsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        UselessFactsResultBody::call($ctx);
