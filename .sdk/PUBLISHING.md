...
|---|---|---|
| `ts/` | @voxgig-sdk/useless-facts-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/useless-facts-sdk \
      --repository voxgig-sdk/useless-facts-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/useless-facts-sdk` shows it, and
`npm trust revoke @voxgig-sdk/useless-facts-sdk --id=<id>` removes it.
