...
// UselessFacts SDK streaming feature
...
class UselessFactsStreamingFeature extends UselessFactsBaseFeature
{
    ...
    private function _iterate(UselessFactsResult $result): \Generator
    {
    ...
    private function _streamable(UselessFactsContext $ctx): bool
    {
