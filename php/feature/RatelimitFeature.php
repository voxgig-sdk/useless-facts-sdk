...
// UselessFacts SDK ratelimit feature
...
class UselessFactsRatelimitFeature extends UselessFactsBaseFeature
{
    ...
    private function _acquire(UselessFactsContext $ctx): void
    {
    ...
    private function _track(UselessFactsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
