...
// UselessFacts SDK proxy feature
...
class UselessFactsProxyFeature extends UselessFactsBaseFeature
{
    ...
    public function init(UselessFactsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (UselessFactsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
