...
// UselessFacts SDK netsim feature
...
class UselessFactsNetsimFeature extends UselessFactsBaseFeature
{
    ...
    private function _simulate(UselessFactsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(UselessFactsContext $ctx, array $applied): void
    {
        $client = $this->client;
