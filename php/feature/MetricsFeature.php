...
// UselessFacts SDK metrics feature
...
class UselessFactsMetricsFeature extends UselessFactsBaseFeature
{
    ...
    private function _record(UselessFactsContext $ctx, bool $ok): void
    {
