...
// UselessFacts SDK telemetry feature
...
class UselessFactsTelemetryFeature extends UselessFactsBaseFeature
{
    ...
    private function _close(UselessFactsContext $ctx, bool $ok): void
    {
