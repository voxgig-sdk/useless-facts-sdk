...
// UselessFacts SDK clienttrack feature
...
class UselessFactsClienttrackFeature extends UselessFactsBaseFeature
{
    ...
    public function PostConstruct(UselessFactsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'UselessFacts-SDK';
