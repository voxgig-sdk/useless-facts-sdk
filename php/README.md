# UselessFacts PHP SDK

The PHP SDK for the UselessFacts API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->UselessFacts(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── uselessfacts_sdk.php          -- Main SDK class
...
The main class (`uselessfacts_sdk.php`) exports the SDK class
