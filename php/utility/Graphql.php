...
// UselessFacts SDK utility: graphql
//
...
class UselessFactsGraphql
{
    ...
    // equivalent.
    public static function body(UselessFactsContext $ctx): mixed
    {
    ...
    public static function errors(UselessFactsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
