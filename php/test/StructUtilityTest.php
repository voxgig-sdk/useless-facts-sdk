...
// UselessFacts SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = UselessFactsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(UselessFactsOmni::structfix($now, Struct::undef()))
                        !== json_encode(UselessFactsOmni::structfix($val, Struct::undef()))) {
