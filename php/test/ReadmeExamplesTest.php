...
// UselessFacts SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (UselessFactsSDK::test)
...
{
    private const SDK_CLASS = 'UselessFactsSDK';
    ...
    private const SDK_BASE = 'uselessfacts_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../uselessfacts_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
