// Command UselessFacts-cli is a CLI + REPL for the UselessFacts SDK,
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      USELESS_FACTS_APIKEY (api key), USELESS_FACTS_BASE (base url override)")
...
func run(args []string, in io.Reader, out, errOut io.Writer) int {
	...
	// Configure from the environment: USELESS_FACTS_APIKEY carries the API key and
	// USELESS_FACTS_BASE optionally overrides the API base URL (e.g. production).
	// Both injectable by a secrets vault. Unset -> nil config defaults.
	var opts map[string]any
	if apikey := os.Getenv("USELESS_FACTS_APIKEY"); apikey != "" {
		opts = map[string]any{"apikey": apikey}
	}
	if base := os.Getenv("USELESS_FACTS_BASE"); base != "" {
		if opts == nil {
			opts = map[string]any{}
		}
		opts["base"] = base
	}
	client := sdk.NewUselessFactsSDK(opts)
