...
AQL-driven CLI and REPL for the UselessFacts SDK. Positional arguments are
...
./useless-facts-cli list random
./useless-facts-cli load 1 random
./useless-facts-cli load '{id:1}' random
