...
func registerSDKWords(r *eng.Registry, client *sdk.UselessFactsSDK) {
...
func runOp(client *sdk.UselessFactsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
