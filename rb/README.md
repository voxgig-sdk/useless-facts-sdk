# UselessFacts Ruby SDK



The Ruby SDK for the UselessFacts API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `UselessFactsError` (a `StandardError` subclass), so wrap
...
```
rb/
├── UselessFacts_sdk.rb       -- Main SDK module
