...
func registerTools(server *mcp.Server, client *sdk.UselessFactsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "useless-facts_list",
		Description: "List records from UselessFacts. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "useless-facts_load",
		Description: "Load a single record from UselessFacts. " +
...
func runOp(client *sdk.UselessFactsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.UselessFactsSDK, name string) (sdk.UselessFactsEntity, error) {
