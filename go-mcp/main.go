// Command UselessFacts-mcp is an MCP server exposing the UselessFacts
// SDK as MCP tools.
//
// Two tools are registered:
//
//	UselessFacts_list  — list records of an entity
//	UselessFacts_load  — load a single record of an entity
//
