...
const testSeed = `map[string]any{"entity": map[string]any{"random": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "today": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
