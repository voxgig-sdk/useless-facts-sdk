...
func (sdk *UselessFactsSDK) OptionsMap() map[string]any {
...
func (sdk *UselessFactsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *UselessFactsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *UselessFactsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UselessFactsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *UselessFactsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *UselessFactsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("UselessFactsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *UselessFactsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *UselessFactsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("UselessFactsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *UselessFactsSDK) Random(data map[string]any) UselessFactsEntity {
...
func (sdk *UselessFactsSDK) Today(data map[string]any) UselessFactsEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *UselessFactsSDK {
	...
	sdk := NewUselessFactsSDK(sdkopts)
	sdk.Mode = "test"
