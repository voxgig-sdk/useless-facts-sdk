# UselessFacts Golang SDK Reference

Complete API reference for the UselessFacts Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *UselessFactsSDK`
...
#### `Random(data map[string]any) UselessFactsEntity`

Create a new `Random` entity instance. Pass `nil` for no initial data.

#### `Today(data map[string]any) UselessFactsEntity`
