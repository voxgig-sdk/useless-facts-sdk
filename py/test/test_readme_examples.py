# UselessFacts SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions UselessFactsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both UselessFactsSDK(...) and UselessFactsSDK.test(...) become
#      UselessFactsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "uselessfacts_sdk"
_SDK_CLASS = "UselessFactsSDK"
