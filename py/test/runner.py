...
class UselessFactsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = UselessFactsTestRunner.getenv("USELESSFACTS_TEST_LIVE")
        override = UselessFactsTestRunner.getenv("USELESSFACTS_TEST_OVERRIDE")
        ...
        explain = UselessFactsTestRunner.getenv("USELESSFACTS_TEST_EXPLAIN")
