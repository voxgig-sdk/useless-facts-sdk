...
from uselessfacts_sdk.core.helpers import get_ctx_prop, to_map
...
class UselessFactsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, UselessFactsSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, UselessFactsResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, UselessFactsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return UselessFactsError(code, msg, self)
