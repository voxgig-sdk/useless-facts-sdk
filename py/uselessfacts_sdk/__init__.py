...
from uselessfacts_sdk.utility import register

# Load features
from uselessfacts_sdk.feature.base_feature import UselessFactsBaseFeature
from uselessfacts_sdk.features import _has_feature, _make_feature
...
class UselessFactsSDK:
    ...
    def get_utility(self):
        return UselessFactsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("UselessFactsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from uselessfacts_sdk.entity.random_entity import RandomEntity
        return RandomEntity(self, data)


    def Today(self, data=None) -> "TodayEntity":
        """Entity factory: client.Today().list() / client.Today().load({"id": ...})."""
        from uselessfacts_sdk.entity.today_entity import TodayEntity
