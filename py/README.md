# UselessFacts Python SDK



The Python SDK for the UselessFacts API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/useless-facts-sdk/releases)) or
...
```python
client = UselessFactsSDK.test(testopts, sdkopts)
```
...
| `language` | `str` | Language code of the fact |
| `permalink` | `str` | Permanent link to the fact |
| `source` | `str` | Source of the fact |
| `source_url` | `str` | URL to the fact source |
| `text` | `str` | The useless fact text |
...
```
py/
├── uselessfacts_sdk.py         -- Main SDK module
...
The main module (`uselessfacts_sdk`) exports the SDK class.
